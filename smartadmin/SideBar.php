...
class SideBar extends \yii\widgets\Menu
{
    ...
    public function renderItems($items)
    {
        ...
        foreach ($items as $item) {
            ...
            if ($item['label'] == 'chat') {
                $lines[] = Html::tag('li', Html::a('<i class="fa fa-lg fa-fw fa-comment-o"></i> <span class="menu-item-parent">Chats</span>', '#', $linkOptions) .
                    Html::tag('ul', $this->renderChat), ['class' => "chat-users top-menu-invisible", "ng-app" => "chat_app", "ng-controller" => "chat_ctrl"]);
            } else {
    ...
    public function getRenderChat()
    {
        return Html::tag('li', Html::tag('div', Yii::$app->CheckOnline->chatMenu(), ['class' => 'display-users']));
    }
...
//    }
    ...
    public static function isActiveItems($item)
    {
        return (new self)->isItemActive($item);
    }
}